...
DEFAULT_CONF = {
    ...
    "wifi_auto_attivo": 0,            # 0=disabilitato, 1=riconnessione Wi-Fi automatica (elenco in dati/wifi.json)
    "wifi_auto_intervallo": 15,       # Secondi tra un controllo e l'altro (min 5)
    "topmost_attivo": 1,              # 0=finestra normale, 1=sempre in primo piano (necessario su uConsole, opzionale su PC)
}

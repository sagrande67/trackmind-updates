    ...
    try:
        ...
        for i, (nome_file, cartella) in enumerate(files.items(), 1):
            ...
            try:
                ...
                # File di shell (.sh): aggiungi bit di esecuzione (0o755).
                # Senza questo, dopo l'OTA un avvia.sh scaricato non sarebbe
                # eseguibile e l'utente vedrebbe "Permission denied".
                if nome_file.lower().endswith(".sh"):
                    try:
